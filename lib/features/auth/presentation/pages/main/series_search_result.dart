...
class SeriesSearchResult extends StatefulWidget {
  static route() =>
      MaterialPageRoute(builder: (context) => const SeriesSearchResult());
  const SeriesSearchResult({super.key});

  @override
  State<SeriesSearchResult> createState() => _SeriesSearchResultState();
}

class _SeriesSearchResultState extends State<SeriesSearchResult> {
  int _currentIndex = 0;
